...
const s = {
  ...
  header: {
    background:
      "linear-gradient(135deg, #f5c518 0%, #e8a000 60%, #c47a00 100%)",
    ...
    <section style={s.section}>
      ...
      <div style={s.header}>
        <div style={s.headerTop}>
          <div>
            <div style={s.headerTitle}>🥇 सोना</div>
            <div style={s.headerTitleHindi}>
              Gold — आज का भाव (प्रति 10 ग्राम)
            </div>
          </div>
        </div>
        <div style={s.badgesRow}>
          <div style={s.badge}>
            ...
            <span style={s.badgePrice}>
              ₹ {(prices.gold750 || 0).toLocaleString("en-IN")}
            </span>
          </div>
          <div style={s.badge}>
            <span style={s.badgeLabel}>916 KDM (22 कैरेट)</span>
            <span style={s.badgePrice}>
              ₹ {(prices.gold916 || 0).toLocaleString("en-IN")}
            </span>
          </div>
        </div>
      </div>
        ...
        <div style={s.grid}>
          ...
          <div style={s.field}>
            ...
            <input
              ...
              style={s.input}
              onFocus={(e) => {
                e.target.style.borderColor = "#c47a00";
                e.target.style.boxShadow = "0 0 0 3px rgba(218,165,32,0.18)";
              }}
              onBlur={(e) => {
                e.target.style.borderColor = "#e0c050";
