...
const styles = {
  page: {
    minHeight: '100vh',
    background: 'linear-gradient(160deg, #1a1200 0%, #2d1f00 40%, #1a1a2e 100%)',
    display: 'flex',
  ...
  calcCard: {
    background: 'linear-gradient(145deg, rgba(255,215,0,0.12), rgba(255,165,0,0.06))',
  ...
  loginCard: {
    background: 'linear-gradient(145deg, rgba(192,192,192,0.1), rgba(128,128,128,0.05))',
...
export default function Home() {
  ...
  function calcHover(e, enter) {
    if (enter) {
      e.currentTarget.style.background = 'linear-gradient(145deg, rgba(255,215,0,0.22), rgba(255,165,0,0.14))'
      ...
      e.currentTarget.style.background = 'linear-gradient(145deg, rgba(255,215,0,0.12), rgba(255,165,0,0.06))'
  ...
  function loginHover(e, enter) {
    if (enter) {
      e.currentTarget.style.background = 'linear-gradient(145deg, rgba(192,192,192,0.2), rgba(128,128,128,0.12))'
      e.currentTarget.style.border = '1.5px solid rgba(192,192,192,0.55)'
      e.currentTarget.style.transform = 'translateY(-5px)'
      e.currentTarget.style.boxShadow = '0 16px 48px rgba(0,0,0,0.3)'
    } else {
      e.currentTarget.style.background = 'linear-gradient(145deg, rgba(192,192,192,0.1), rgba(128,128,128,0.05))'
  ...
  return (
    <div style={styles.page}>
      ...
      <p style={styles.footer}>
        © 2024 Khatri Alankar Jewellers<br />
